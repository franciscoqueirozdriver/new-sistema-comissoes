...
export default function ConfiguracoesPage() {
    ...
    const isAdmin = session?.user?.rule === "admin";
    ...
    if (status === "loading") return <div className="p-6 text-center">Verificando autenticação...</div>;
    if (!isAdmin) return <div className="p-6 text-center text-red-500">Acesso restrito. Esta seção é exclusiva para administradores.</div>;
